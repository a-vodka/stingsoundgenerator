...
def cmpwav():
    ...
    ddata2 = np.gradient(data2)
    ddata1 = np.gradient(data1)

    plt.plot(data2[ arg_shift2: arg_shift2+2000], ddata2[ arg_shift2: arg_shift2+2000])
   # plt.show()

    plt.plot(data1[0:2000], ddata1[0:2000])
    plt.show()
